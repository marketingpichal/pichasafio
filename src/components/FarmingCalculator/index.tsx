...
const FarmingCalculator = () => {
  const categorias = [
    { value: "gorda", text: "Gorda", xp: 40, color: "from-red-500 to-pink-500", icon: "🎯" },
    { value: "fea", text: "Fea", xp: 20, color: "from-gray-500 to-gray-600", icon: "😐" },
    { value: "extranjera", text: "Extranjera", xp: 40, color: "from-blue-500 to-cyan-500", icon: "🌍" },
    { value: "novia", text: "Novia", xp: 1000, color: "from-pink-500 to-rose-500", icon: "💕" },
    { value: "amiga", text: "Amiga", xp: 10, color: "from-green-500 to-emerald-500", icon: "👭" },
    { value: "normal", text: "Normal", xp: 10, color: "from-blue-500 to-purple-500", icon: "👤" },
    { value: "buena", text: "Buena", xp: 5, color: "from-yellow-500 to-orange-500", icon: "👍" },
    { value: "top", text: "Top", xp: 200, color: "from-purple-500 to-pink-500", icon: "🏆" },
  ];

  const penalizaciones = [
    { value: "none", text: "Sin penalización", factor: 1, color: "from-green-500 to-emerald-500", icon: "✅" },
    { value: "leve", text: "Leve", factor: 0.5, color: "from-yellow-500 to-orange-500", icon: "⚠️" },
    { value: "media", text: "Media", factor: 0.25, color: "from-orange-500 to-red-500", icon: "🚨" },
    { value: "grave", text: "Grave", factor: 0, color: "from-red-500 to-pink-500", icon: "💀" },
    { value: "ban", text: "Ban", factor: 0, color: "from-gray-500 to-gray-600", icon: "🚫" },
  ];
  ...
  const calcularXP = async () => {
    ...
    try {
      ...
      setShowSuccess(true);
      setHistorial((prev) => [
        `${categoriaSeleccionada.icon} ${categoriaSeleccionada.text} con ${penalizacionSeleccionada.icon} ${penalizacionSeleccionada.text}: +${xpGanada} XP - Total: ${newPoints} XP - ${new Date().toLocaleTimeString()}`,
        ...prev,
      ]);
  ...
  const getCategoriaSeleccionada = () => categorias.find(cat => cat.value === categoria);
  const getPenalizacionSeleccionada = () => penalizaciones.find(pen => pen.value === penalizacion);
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-300 text-lg sm:text-xl max-w-3xl mx-auto leading-relaxed font-poppins-light">
            Calcula tu XP y sube en el ranking. Gana puntos por tus interacciones y compite con otros usuarios.
          </p>
        </motion.div>
        ...
        {showSuccess && (
          ...
          >
            <div className="bg-gradient-to-r from-green-500 to-emerald-600 text-white px-6 py-4 rounded-xl shadow-xl flex items-center space-x-3">
              ...
              <div>
                <p className="font-semibold font-poppins-semibold">¡XP Ganada!</p>
                <p className="text-sm font-poppins-light">+{lastXpGained} XP agregada a tu cuenta</p>
              </div>
            </div>
          </motion.div>
        )}
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <h3 className="text-lg font-semibold text-white font-poppins-semibold">Categoría</h3>
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <h3 className="text-lg font-semibold text-white font-poppins-semibold">Penalización</h3>
                </div>
              ...
              <div className="bg-gradient-to-r from-yellow-500/10 to-orange-500/10 border border-yellow-500/20 rounded-xl p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-lg font-semibold text-white font-poppins-semibold">XP Calculada</h3>
                    <p className="text-gray-300 text-sm font-poppins-light">
                      {getCategoriaSeleccionada()?.text} × {getPenalizacionSeleccionada()?.text}
                    </p>
                  </div>
                  <div className="text-right">
                    ...
                    <div className="text-sm text-gray-300 font-poppins-light">XP</div>
                  </div>
                </div>
              </div>
              ...
              {!canSubmit && (
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="text-yellow-400 font-semibold font-poppins-semibold">Límite Diario Alcanzado</p>
                      <p className="text-gray-300 text-sm font-poppins-light">
        ...
        >
          <ResponsiveCard className="text-center">
            ...
            <h3 className="text-2xl font-bold text-white mb-2 font-poppins-bold">{xpAcumulada}</h3>
            <p className="text-gray-300 text-sm font-poppins-light">XP Acumulada</p>
          </ResponsiveCard>
          ...
          <ResponsiveCard className="text-center">
            ...
            <h3 className="text-2xl font-bold text-white mb-2 font-poppins-bold">{dailyCount}/2</h3>
            <p className="text-gray-300 text-sm font-poppins-light">Registros Hoy</p>
          </ResponsiveCard>
          ...
          <ResponsiveCard className="text-center">
            ...
            <p className="text-gray-300 text-sm font-poppins-light">Nivel Actual</p>
          </ResponsiveCard>
        </motion.div>
              ...
              <div className="space-y-3 max-h-64 overflow-y-auto">
                {historial.map((entrada, index) => (
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-300 font-poppins-light">{entrada}</p>
                  </motion.div>
                ))}
              </div>
            </ResponsiveCard>
